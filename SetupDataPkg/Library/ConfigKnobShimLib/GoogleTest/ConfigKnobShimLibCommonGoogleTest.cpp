...
TEST_F (GetConfigKnobOverrideFromVariableStorageTest, VariableStorageSuccess) {
  ...
  expectMockGetVariableBuffSmall (&VariableData, &RtServicesMock);

  // expectMockGetVariable(&VariableData, &RtServicesMock);
  expectMockGetVariableSuccess (&VariableData, &RtServicesMock);
